...
// Tipo que representa exactamente una fila de la tabla post_new en Supabase
export interface SupabasePostRow {
  id: number;
  image_url: string;
  caption: string;
  likes: number;
  created_at: string;   // Supabase siempre devuelve string ISO
  username: string;
  avatar: string;
}
...
export const posts: Post[] = [
  ...
  },
  {
    ...
    likes: 980,
    isLiked: false,
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 8).toISOString(), // hace 8 horas
  },
  {
    id: 3,
  ...
  },
  {
    ...
    likes: 421,
    isLiked: false,
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 24 * 4).toISOString(), // hace 4 días
  },
  {
    id: 7,
  ...
  },
  {
    ...
    likes: 256,
    isLiked: false,
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 24 * 6).toISOString(), // hace 6 días
  },
  {
    id: 9,
    ...
    likes: 128,
    isLiked: false,
    created_at: new Date(Date.now() - 1000 * 60 * 60 * 24 * 7).toISOString(), // hace 1 semana
  },
];
